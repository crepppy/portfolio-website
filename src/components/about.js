                ...
                <div className={styles.aboutContainer}>
                    <div className={styles.aboutContent}>
                        <p>Hi, I’m Jack (formerly crepppy), a 16 year-old developer from the UK. I have been working
                            with Java for 4 years as a freelancer offering a variety of affordable services including,
                            ...
                            applications.</p>
                        <p>When you hire me, you can expect an active and experienced developer that can fulfil almost
                            any request at an affordable price with an efficient and organised approach.</p>
                    </div>
